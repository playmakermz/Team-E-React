...
function App(){
  let abc = [pokeball]
  let [pokemonList, setPokemonList] = useState(abc[0].results) // Pengambilan data luar
  let [selectedPokemonName, setSelectedPokemonName] = useState("") // mengabil data user
  let [pokemonDetail, setPokemonDetail] = useState('') // pengambiland data dalam
  ...
  }, [selectedPokemonName]) // user klik button
